...
import { Send, Cpu, MessageSquare, Trash2 } from 'lucide-react'
  ...
  const sendQuery = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/chat/stream', {
        ...
        body: JSON.stringify({ query: userMsg, session_id: sessionId, stream: true }),
      })
  ...
  return (
    <div className="chat-tab-container">
      <div className="chat-panel glass-card">
        ...
        <form onSubmit={sendQuery} className="chat-input-area">
          <input
            ...
            placeholder="Type your diligence query..."
            disabled={streaming}
          />
      ...
      <div className="activity-feed-panel glass-card">
        <h3 className="activity-feed-title" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
